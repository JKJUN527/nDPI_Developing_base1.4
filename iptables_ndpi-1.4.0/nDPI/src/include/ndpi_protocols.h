...
void ndpi_search_qqmusic(struct ndpi_detection_module_struct
			  *ndpi_struct, struct ndpi_flow_struct *flow);

void ndpi_search_funshion(struct ndpi_detection_module_struct
			  *ndpi_struct, struct ndpi_flow_struct *flow);

void ndpi_search_sohu(struct ndpi_detection_module_struct
			  *ndpi_struct, struct ndpi_flow_struct *flow);

void ndpi_search_youku(struct ndpi_detection_module_struct
			  *ndpi_struct, struct ndpi_flow_struct *flow);
...
void ndpi_search_dragonoath(struct ndpi_detection_module_struct *ndpi_struct, struct ndpi_flow_struct *flow);
...
void ndpi_search_speed(struct ndpi_detection_module_struct *ndpi_struct, struct ndpi_flow_struct *flow);
...
void ndpi_search_rip(struct ndpi_detection_module_struct *ndpi_struct, struct ndpi_flow_struct *flow);
